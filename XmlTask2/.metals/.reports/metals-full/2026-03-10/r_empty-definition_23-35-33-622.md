error id: file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/Collector.java:ru/nsu/shelestov/XML1/data/Person#
file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/Collector.java
empty definition using pc, found symbol in pc: ru/nsu/shelestov/XML1/data/Person#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 146
uri: file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/Collector.java
text:
```scala
package ru.nsu.shelestov.XML1;

import lombok.AllArgsConstructor;
import data.ru.nsu.pronin.XML2.PeopleInfo;
import ru.nsu.shelestov.XML1.data.@@Person;
import data.ru.nsu.pronin.XML2.PersonToRole;
