error id: file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/data/Person.java:lombok/Setter#
file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/data/Person.java
empty definition using pc, found symbol in pc: lombok/Setter#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 73
uri: file://<WORKSPACE>/src/main/java/ru/nsu/shelestov/XML1/data/Person.java
text:
```scala
package ru.nsu.shelestov.XML1.data;
